...
function About() {
  return (
    <div className='min-h-screen w-full flex flex-col lg:flex-row lg:justify-around bg-yellow-400 lg:p-4'>
        <div className="w-full flex flex-col justify-around items-center lg:w-1/3 bg-yellow-400 p-3">
            <span className='w-3/5'>
                <img src="https://scontent-los2-1.xx.fbcdn.net/v/t39.30808-6/278660500_5251166998276940_1945795077603890117_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeGMI5darCcK3VpP2hwflXLwVLjCl9MuNmlUuMKX0y42abmp3iNdU3sTubsCrjpiw7c0pbqLu4Bfr6jvBnrQDsR5&_nc_ohc=MXFvFm4GNxQAX_cSD6u&_nc_ht=scontent-los2-1.xx&oh=00_AfAO5Ya-KP12EwzbVEcZ6Y-QeU6uEfpj_fR8sDZIji2L6g&oe=6372FBC1" alt="shev" className='bg-red w-full rounded-full bg-red-400'/>
            </span>
            <div className='text-center'>
                <h6 className='font-semibold text-xl '>About Sherif</h6>
                <p>I am a goal-driven, quality-oriented professional with knowledge of web development. I am a lifelong
